...
public class JavaCodeGenerationTest {
    ...
    private static List<GeneratedJavaFile> generateJavaFilesMybatis() throws Exception {
        createDatabase();
        List<GeneratedJavaFile> generatedJavaFiles = generateJavaFiles("/scripts/generatorConfig.xml");
        return generatedJavaFiles;
    }

    private static List<GeneratedJavaFile> generateJavaFilesMybatisDsql() throws Exception {
        createDatabase();
        List<GeneratedJavaFile> generatedJavaFiles = generateJavaFiles("/scripts/generatorConfig_Dsql.xml");
        return generatedJavaFiles;
    }
